...
const projectsData = {
  'amped': {
    ...
    overview: 'Inspired by Dr. Suneel Dhand, I created a directory for patients seeking practitioners whose views on healthcare are more traditional.'
  },
  'pneuma-collection': {
  ...
  'knack': {
    ...
    label: '',
    heroImage: '',
    description: 'An interactive reading app for kids.',
    sections: [
      {
        type: 'single',
        title: '',
    ...
    sections: [
      {
        ...
        image: 'https://i.imgur.com/uUXqZ3d.png?auto=compress&cs=tinysrgb&w=600'
      }
    ],
  ...
  'civic-social': {
    ...
    label: '',
    heroImage: '',
    description: 'Voting platform for decentralizing legislation.',
    sections: [
      {
        type: 'single',
        title: '',
        text: 'What if every citizen could actively participate in shaping their own community?',
    ...
    sections: [
      {
        ...
        image: 'https://i.imgur.com/DfndDEI.png?auto=compress&cs=tinysrgb&w=600'
      }
    ],
    ...
    sections: [
      {
        ...
        image: 'https://i.imgur.com/DZcsdI1.png?auto=compress&cs=tinysrgb&w=600'
      }
    ],
  ...
  'solaria-handbag': {
    ...
    label: '',
    heroImage: '',
    description: 'An AI-generated premium handbag.',
    sections: [
      {
        type: 'single',
        title: '',
    ...
    overview: 'The Solaria handbag redefines premium luxury. Generated by AI, but manufactured through traditional craftsmanship.'
  },
    ...
    sections: [
      {
        ...
        video: 'https://i.imgur.com/RNisHGQ.mp4?auto=compress&cs=tinysrgb&w=600'
      }
    ],
    ...
    sections: [
      {
        ...
        video: 'https://i.imgur.com/lRQUd6S.mp4?auto=compress&cs=tinysrgb&w=600'
      }
    ],
