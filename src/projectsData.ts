...
export const projectsData: Record<string, ProjectData> = {
  "ggs": {
    ...
    images: [
      {
        src: "https://i.imgur.com/I23nYjZ.png?auto=compress&cs=tinysrgb&w=1200",
        alt: "Good Games Hero",
        size: "large",
      },
      {
  ...
  "altamed": {
    ...
    description: "Accessible healthcare platform connecting patients with quality medical services.",
    images: [
      {
  ...
  "civic-social": {
    ...
    images: [
      {
        src: "https://i.imgur.com/zOAd5qr.png?auto=compress&cs=tinysrgb&w=1200",
  ...
  "baraka": {
    ...
    tagline: "✐ᝰ financial freedom for all",
    description: "Innovative fintech platform providing financial services to underserved communities.",
    images: [
      {
        src: "https://i.imgur.com/2hBPNJ7.png?auto=compress&cs=tinysrgb&w=1200",
        alt: "Baraka Hero",
        size: "large",
      },
      {
    ...
    overview: "Baraka is a mobile-first fintech platform that brings banking services to the unbanked. It features instant transfers, savings programs, and financial literacy tools.",
    tools: ["Flutter", "Kotlin", "Node.js", "Stripe API"],
    role: "Lead Designer",
    year: "2023",
  },
  "buku-tv": {
    ...
    images: [
      {
        src: "https://i.imgur.com/W9YVpm6.gif?auto=compress&cs=tinysrgb&w=800",
        alt: "Buku TV Hero",
        size: "large",
      },
      {
  ...
  "pneuma-collection": {
    ...
    subtitle: "mindfulness & breathwork app",
    tagline: "✐ᝰ breathe, center, thrive",
    description: "Guided breathing and mindfulness platform for mental wellness.",
    images: [
      {
        src: "https://i.imgur.com/CEqlRoO.png?auto=compress&cs=tinysrgb&w=1200",
        alt: "Pneuma Hero",
        size: "large",
      },
      {
    ...
    overview: "Pneuma provides guided breathing exercises and meditation sessions. The app uses haptic feedback and ambient sounds to enhance relaxation and mindfulness practices.",
    tools: ["React Native", "Audio APIs", "Haptic Engine", "Analytics"],
