...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            // For now, log the form data (in production, send to backend)
            console.log('Contact form submitted:', formData);
            
            // Send email via backend (you'll need to set up an endpoint)
            ...
            .catch(error => {
                ...
                // Fallback: If backend endpoint doesn't exist, just show success
